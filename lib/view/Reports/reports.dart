...
import 'package:demo/view/Reports/Widgets/Drawer_Right/report_drawerselection.dart';
import 'package:demo/view/Reports/Widgets/icon_popup.dart';
import 'package:demo/view/Reports/Widgets/report_drop.dart';
import 'package:demo/view/Reports/Widgets/report_tabledata.dart';
...
class _ReportPageState extends State<ReportPage> {
  ...
  late final BoolDrawerController _drawerSelect =
      Get.put(BoolDrawerController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      endDrawer: const DrawerSelection(),
                ...
                Flexible(
                  child: Padding(
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        setState(() {
                          _drawerSelect.reportFilterDrawer.value = true;
                        });
